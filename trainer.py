...
#latt
 ...
 #   print('opt.feat_merge in trainer', opt.feat_merge)
    ...
    trainer = onmt.Trainer(model, train_loss, valid_loss, optim, trunc_size,
                           ...
                           model_saver=model_saver, feat_merge = opt.feat_merge)
    return trainer
...
class Trainer(object):
    ...
    def __init__(self, model, train_loss, valid_loss, optim,
                 ...
                 gpu_verbose_level=0, report_manager=None, model_saver=None, feat_merge = 'concat'): 
                                                                                    #latt argument
        # Basic attributes.
        self.model = model
...
#latt argument
    ...
    def validate(self, valid_iter):
        ...
        for batch in valid_iter:
            ...
            outputs, attns, _ = self.model(src, tgt, src_lengths, self.feat_merge)
#latt                                                              # latt
    ...
    def _gradient_accumulation(self, true_batchs, normalization, total_stats,
        ...
        for batch in true_batchs:
            ...
            for j in range(0, target_size-1, trunc_size):
                ...
                if self.grad_accum_count == 1:
                    self.model.zero_grad()
       #         print('self.feat_merge in trainer.py gradient accml', self.feat_merge)
                outputs, attns, dec_state = \
                    self.model(src, tgt, src_lengths, self.feat_merge, dec_state)
  #latt                                              latt argument
