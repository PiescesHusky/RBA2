        ...
        if self.train:
            ...
            for b in torchtext.data.batch(self.data(), self.batch_size,
             ...
             #   self.batches.append(sorted(b, key=self.sort_key))
                self.batches.append(b) # try unsort
                print('batch_append')
    ...
    def create_batches(self):
        if self.train:
            ...
            for b in batch_iter(
                ...
                # self.batches.append(b)  # latt sorted removed
        ...
        while True:
            ...
            for idx, minibatch in enumerate(self.batches):
                ...
                if self.sort_within_batch:
                    ...
                    print(minibatch[0]) #test
                    
                    # latt try-out: two options below doesn't seem to make any difference
                    if self.sort:
                        #print('self.sort') #test
                        minibatch.reverse()
                    else:
                        #print('else') #test
...
class DatasetLazyIter(object):
    ...
    def _next_dataset_iterator(self, dataset_iter):
        ...
        return OrderedIterator(
            ...
            sort=False, sort_within_batch=True,   # latt sort=False, sort_within_batch=True changed to False
            repeat=False)
