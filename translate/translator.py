 ...
 #latt
    ...
    def translate(self,
        ...
        data_iter = inputters.OrderedIterator(
            ...
            batch_size=batch_size, train=False, sort=False,  # batch_size=batch_size, train=False, sort=False,
            sort_within_batch=True, shuffle=False)   # latt sort_within_batch=True, shuffle=False changed to False
        ...
        for batch in data_iter:
            ...
            for trans in translations:
                ...
                if attn_debug:
                    ...
                    attns = trans.attns[0].tolist()    # latt Try diff value, default = 0. only 0 works, 1 is out of index
        ...
        if self.report_score:
            print('pred_words_total', pred_words_total) # test latt
            ...
            if self.logger:
                ...
                print(msg)
            if tgt_path is not None:
                print('gold_words_total', gold_words_total) # test latt
